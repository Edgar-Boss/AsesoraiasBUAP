                        ...
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            ...
                            <div class="login-content">
                                <?php if(!empty($user)): ?>
                                    ...
                                    <a href="perfil.html">Ver cursos </a>  //
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                                <a href="index.php"></i> <span>Asesorias BUAP</span></a>
                            </div>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 data-animation="fadeInUp" data-delay="100ms">Las asesorias que necesitas</h4>
                                <h2 data-animation="fadeInUp" data-delay="400ms">Bienvenido a  <br>Asesorias BUAP</h2>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="single-top-features d-flex align-items-center justify-content-center">
                                    ...
                                    <h5>Asesores de la comunidad BUAP</h5>
                                </div>
                            </div>
                            <!-- Single Top Features -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta-content d-flex align-items-center justify-content-between flex-wrap">
                        <h3>¿Deseas formar parte de la comunidad de asesorias BUAP?</h3>
